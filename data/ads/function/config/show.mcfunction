...
# Enable Rank Advantage
execute as @a[scores={ads.config=1020}] at @s run playsound block.note_block.hat ui @s ~ ~ ~ 0.8 1 0
tellraw @a[scores={ads.config=1020}] [{text:"LᴇɢɪᴛɪAᴅꜱ ",color:yellow},{text:">> ",color:dark_gray},{text:"Ad Order set to Rᴀɴᴅᴏᴍ.",color:yellow}]
execute as @a[scores={ads.config=1020}] run scoreboard players set .random_ads ads.config 1


execute as @a[scores={ads.config=1021}] at @s run playsound block.note_block.hat ui @s ~ ~ ~ 1.5 1 0
tellraw @a[scores={ads.config=1021}] [{text:"LᴇɢɪᴛɪAᴅꜱ ",color:yellow},{text:">> ",color:dark_gray},{text:"Ad Order set to Oʀᴅᴇʀᴇᴅ.",color:yellow}]
execute as @a[scores={ads.config=1021}] run scoreboard players set .random_ads ads.config 0
