# Return if no ads
execute if entity @s[tag=is_whitelisted] if score .wl_ads ads.config matches 0 run return fail
execute if entity @s[tag=is_admin] if score .admin_ads ads.config matches 0 run return fail
execute if entity @s[tag=is_dev] if score .dev_ads ads.config matches 0 run return fail
execute if entity @s[tag=is_coowner] if score .co_ads ads.config matches 0 run return fail
execute if entity @s[tag=is_owner] if score .owner_ads ads.config matches 0 run return fail
